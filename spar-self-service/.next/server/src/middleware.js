...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=%2Fhome%2Ftechno-530%2FDownloads%2FWorkspace%2FWorkspace-spar%2Fopeng2p-spar-self-service-ui%2Fspar-self-service&matchers=W3sicmVnZXhwIjoiXlxcL3NwYXIoPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT8oPzpcXC8oXFwvP2luZGV4fFxcLz9pbmRleFxcLmpzb24pKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiLyJ9LHsicmVnZXhwIjoiXlxcL3NwYXIoPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT8oPzpcXC8oZnJ8dGx8ZW4pKSg%2FOlxcLygoPzpbXlxcLyNcXD9dKz8pKD86XFwvKD86W15cXC8jXFw%2FXSs%2FKSkqKSk%2FKC5qc29uKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiLyhmcnx0bHxlbikvOnBhdGgqIn1d&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXlxcL3NwYXIoPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT8oPzpcXC8oXFwvP2luZGV4fFxcLz9pbmRleFxcLmpzb24pKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiLyJ9LHsicmVnZXhwIjoiXlxcL3NwYXIoPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT8oPzpcXC8oZnJ8dGx8ZW4pKSg%2FOlxcLygoPzpbXlxcLyNcXD9dKz8pKD86XFwvKD86W15cXC8jXFw%2FXSs%2FKSkqKSk%2FKC5qc29uKT9bXFwvI1xcP10%2FJCIsIm9yaWdpbmFsU291cmNlIjoiLyhmcnx0bHxlbikvOnBhdGgqIn1dfQ%3D%3D!
...
var a = __webpack_require__(553), t = __webpack_require__(308), n = __webpack_require__(501), l = __webpack_require__(644), o = __webpack_require__(692);
exports["default"] = function(r) {
    ...
    return function(r) {
        var i, c;
        const d = decodeURI(r.nextUrl.pathname), { domain: h, locale: u } = l.default(s, r.headers, r.cookies, d), f = s.localeDetection && (null === (i = r.cookies.get(a.COOKIE_LOCALE_NAME)) || void 0 === i ? void 0 : i.value) !== u, m = h ? h.defaultLocale === u : u === s.defaultLocale, p = (null === (c = s.domains) || void 0 === c ? void 0 : c.filter((e)=>o.isLocaleSupportedOnDomain(u, e))) || [], v = null != s.domains && !h;
        function x(t) {
            ...
            return r.nextUrl.basePath && (n.pathname = o.applyBasePath(n.pathname, r.nextUrl.basePath)), NextResponse.rewrite(n, function() {
                ...
                return e.set(a.HEADER_LOCALE_NAME, u), {
                    request: {
                        headers: e
                    }
                };
        ...
        function P(a, t) {
            ...
            if (p.length > 0 && !t) {
                const e = o.getBestMatchingDomain(h, u, p);
                e && (t = e.domain, e.defaultLocale === u && "as-needed" === s.localePrefix && n.pathname.startsWith("/".concat(u)) && (n.pathname = o.getNormalizedPathname(n.pathname, s.locales)));
            }
            var l, i;
            t && (n.host = t, r.headers.get("x-forwarded-host") && (n.protocol = null !== (l = r.headers.get("x-forwarded-proto")) && void 0 !== l ? l : r.nextUrl.protocol, n.port = null !== (i = r.headers.get("x-forwarded-port")) && void 0 !== i ? i : ""));
            return r.nextUrl.basePath && (n.pathname = o.applyBasePath(n.pathname, r.nextUrl.basePath)), NextResponse.redirect(n.toString());
        }
        const g = o.getNormalizedPathname(d, s.locales), L = o.getPathnameLocale(d, s.locales), E = null != L;
        let U, O, A = d;
        if (s.pathnames) {
            let e;
            if ([e, O] = o.getInternalTemplate(s.pathnames, g, u), O) {
                const a = s.pathnames[O], n = "string" == typeof a ? a : a[u];
                if (t.matchesPathname(n, g)) A = o.formatTemplatePathname(g, n, O, L);
                else {
                    let t;
                    t = e ? "string" == typeof a ? a : a[e] : O;
                    const l = !E && m || "never" === s.localePrefix ? void 0 : u;
                    U = P(o.getPathWithSearch(o.formatTemplatePathname(g, t, n, l), r.nextUrl.search));
                }
            }
        }
        if (!U) if ("/" === A) {
            const e = o.getPathWithSearch("/".concat(u), r.nextUrl.search);
            U = "never" === s.localePrefix || m && "as-needed" === s.localePrefix ? x(e) : P(e);
        } else {
            const e = o.getPathWithSearch(A, r.nextUrl.search);
            if (E) {
                const a = o.getPathWithSearch(g, r.nextUrl.search);
                if ("never" === s.localePrefix) U = P(a);
                else if (L === u) if (m && "as-needed" === s.localePrefix) U = P(a);
                else if (s.domains) {
                    const t = o.getBestMatchingDomain(h, L, p);
                    U = (null == h ? void 0 : h.domain) === (null == t ? void 0 : t.domain) || v ? x(e) : P(a, null == t ? void 0 : t.domain);
                } else U = x(e);
                else U = P("/".concat(u).concat(a));
            } else U = "never" === s.localePrefix || m && ("as-needed" === s.localePrefix || s.domains) ? x("/".concat(u).concat(e)) : P("/".concat(u).concat(e));
        }
        var _;
        (f && U.cookies.set(a.COOKIE_LOCALE_NAME, u, {
            ...
            config: s,
            localizedPathnames: null != O ? null === (_ = s.pathnames) || void 0 === _ ? void 0 : _[O] : void 0,
            request: r,
            resolvedLocale: u
        }));
        return U;
...
var e = __webpack_require__(146), t = __webpack_require__(230), n = __webpack_require__(553), o = __webpack_require__(692);
function a(e) {
...
function i(e, t) {
    const n = o.getFirstPathnameSegment(e);
    return o.findCaseInsensitiveLocale(n, t);
}
function r(e, t) {
    if (e.has(n.COOKIE_LOCALE_NAME)) {
        var o;
        const a = null === (o = e.get(n.COOKIE_LOCALE_NAME)) || void 0 === o ? void 0 : o.value;
        if (a && t.includes(a)) return a;
    }
}
function u(e, t, n, o) {
    let a, { defaultLocale: l, localeDetection: u, locales: s } = e;
    return o && (a = i(o, s)), !a && u && n && (a = r(n, s)), !a && u && t && (a = c(t, s, l)), a || (a = l), a;
}
function s(e, t, n, a) {
    const l = function(e, t) {
        var n;
        let a = o.getHost(e);
        if (a = null === (n = a) || void 0 === n ? void 0 : n.replace(/:\d+$/, ""), a && t) return t.find((e)=>e.domain === a);
    }(t, e.domains);
    if (!l) return {
        locale: u(e, t, n, a)
    };
    let s;
    if (a) {
        const t = i(a, e.locales);
        if (t) {
            if (!o.isLocaleSupportedOnDomain(t, l)) return {
                locale: t,
                domain: l
            };
            s = t;
    ...
    if (!s && e.localeDetection && n) {
        const t = r(n, e.locales);
        t && o.isLocaleSupportedOnDomain(t, l) && (s = t);
    }
    if (!s && e.localeDetection && t) {
        const n = c(t, l.locales || e.locales, l.defaultLocale);
        n && (s = n);
    }
    return s || (s = l.defaultLocale), {
        locale: s,
        domain: l
    };
}
exports["default"] = function(e, t, n, o) {
    return e.domains ? s(e, t, n, o) : {
        locale: u(e, t, n, o)
    };
}, exports.getAcceptLanguageLocale = c;
...
function i(e, t) {
    const i = e.split("/"), s = t.split("/"), c = Math.max(i.length, s.length);
    for(let e = 0; e < c; e++){
        const t = i[e], c = s[e];
        if (!t && c) return -1;
        if (t && !c) return 1;
...
function a(t, n) {
    const r = e.templateToRegex(t).exec(n);
    if (!r) return;
    const o = {};
    for(let e = 1; e < r.length; e++){
        var i;
        const n = null === (i = t.match(/\[([^\]]+)\]/g)) || void 0 === i ? void 0 : i[e - 1].replace(/[[\]]/g, "");
        n && (o[n] = r[e]);
    }
    return o;
}
...
exports.applyBasePath = function(e, t) {
    return f(t + e);
}, exports.comparePathnamePairs = i, exports.findCaseInsensitiveLocale = c, exports.formatPathname = u, exports.formatTemplatePathname = function(e, t, n, r) {
    const o = a(t, e);
    let i = "";
    return r && (i = "/".concat(r)), i += u(n, o), i = f(i), i;
}, exports.getBestMatchingDomain = function(e, t, n) {
    let r;
    return e && l(t, e) && (r = e), r || (r = n.find((e)=>e.defaultLocale === t)), r || (r = n.find((e)=>null != e.locales && e.locales.includes(t))), r || null != (null == e ? void 0 : e.locales) || (r = e), r || (r = n.find((e)=>!e.locales)), r;
    ...
    for (const i of o){
        ...
        if ("string" == typeof o) {
            ...
            const t = Object.entries(o), s = t.findIndex((e)=>{
                let [t] = e;
                return t === r;
            });
            s > 0 && t.unshift(t.splice(s, 1)[0]);
    ...
    let n = e;
    return t && (n += t), n;
}, exports.getPathnameLocale = function(e, n) {
    const r = t(e);
    return c(r, n) ? r : void 0;
}, exports.getRouteParams = a, exports.getSortedPathnames = s, exports.isLocaleSupportedOnDomain = l;
